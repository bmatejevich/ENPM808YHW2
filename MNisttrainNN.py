...
def MNisttrainNN(net, batch_size, epochs, lr,train_set,train_sampler,val_sampler,test_set,test_sampler, classes):
    ...
    print("Percentage of predictions that were NOT correct, 1:  ", round(er_1,2))
    print("Percentage of predictions that were NOT correct, 2:  ", round(er_2,2))
    print("Percentage of predictions that were NOT correct, 3:  ", round(er_3,2))
    print("Percentage of predictions that were NOT correct, 4:  ", round(er_4,2))
    print("Percentage of predictions that were NOT correct, 5:  ", round(er_5,2))
    print("Percentage of predictions that were NOT correct, 6:  ", round(er_6,2))
    print("Percentage of predictions that were NOT correct, 7:  ", round(er_7,2))
    print("Percentage of predictions that were NOT correct, 8:  ", round(er_8,2))
    print("Percentage of predictions that were NOT correct, 9:  ", round(er_9,2))
    print("Percentage of predictions that were NOT correct, 0:  ", round(er_0,2))
    print('Sum of top 1 errors: ', round(sum([er_1, er_2, er_3, er_4, er_5, er_6, er_7, er_8, er_9, er_0]),2))
    print('Mean of top 1 errors: ', round(sum([er_1, er_2, er_3, er_4, er_5, er_6, er_7, er_8, er_9, er_0])/10,2))

    print("########################## TESTING DATA TOP 3 ##################################")
    print("TOP 3 Percentage of predictions that WERE correct:  ", round(100 * (top3correct / testcount),2))
    ...
    print("Percentage of predictions that were NOT correct, 9:  ", round(er_9,2))
    print("Percentage of predictions that were NOT correct, 0:  ", round(er_0,2))
    print('Sum of top 3 errors: ', round(sum([er_1, er_2, er_3, er_4, er_5, er_6, er_7, er_8, er_9, er_0]),2))
    print('Mean of top 3 errors: ', round(sum([er_1, er_2, er_3, er_4, er_5, er_6, er_7, er_8, er_9, er_0]) / 10,2))
...
########################################### Training ################################################
    ...
    print("TOP 3 Percentage of predictions that WERE correct:  ", round(100 * (top3correct / traincount),2))
